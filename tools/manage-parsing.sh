...
# ARG_POSITIONAL_SINGLE([command],[command: env, run, build, deploy])
# ARG_POSITIONAL_SINGLE([sub-command],[sub-command: backend, frontend])
...
print_help()
{
	...
	printf '\t%s\n' "<command>: command: env, run, build, deploy"
	printf '\t%s\n' "<sub-command>: sub-command: backend, frontend"
