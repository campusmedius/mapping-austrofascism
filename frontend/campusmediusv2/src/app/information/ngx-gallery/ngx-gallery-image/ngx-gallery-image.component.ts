  ...
  animations: [
    trigger('animation', [
      ...
      transition('rotateLeft => void', [
        animate('100ms ease-in-out', style({transform: 'scale(1, 1) rotate(-90deg)', opacity: '0'}))
      ]),
      transition('void => rotateLeft', [
        style({transform: 'scale(1, 1) rotate(-90deg)', opacity: '0'}),
        animate('100ms ease-in-out', style({transform: 'scale(1, 1) rotate(0deg)', opacity: '1'}))
      ]),
      ...
      transition('zoom => void', [
        animate('100ms ease-in-out', style({transform: 'scale(2.5,2.5)', opacity: '0'}))
      ]),
      transition('void => zoom', [
        style({transform: 'scale(2.5,2.5)', opacity: '0'}),
        animate('100ms ease-in-out', style({transform: 'scale(1, 1)', opacity: '1'}))
      ]),
    ]),
  ]
})
