...
export class PageComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    private updateSiteMetaAndTitle() {
        ...
        if(this.page.titleEn === 'Overview') {
            ...
            canonicalUrl += '/book';
        } else if(this.page.titleEn === 'Disclosure') {
