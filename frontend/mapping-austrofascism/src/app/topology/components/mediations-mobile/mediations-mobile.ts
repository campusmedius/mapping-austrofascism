...
@Component({
  selector: 'cm-mediations-mobile',
  templateUrl: './mediations-mobile.html',
    styleUrls: ['./mediations-mobile.scss'],
    host: {
        '[class.open]': 'opened'
    },
    animations: [
...
export class MediationsMobileComponent implements OnInit, AfterViewInit {
